...
describe 'Test Credence Web API' do
    ...
    before do 
        ...
        #Dir.glob - method will return all files that match the globbing rules as an array
        #which can be saved for later use or iterated over
    end
